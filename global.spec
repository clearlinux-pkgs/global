...
Source0  : https://mirrors.kernel.org/gnu/global/global-6.6.11.tar.gz
Source1  : https://mirrors.kernel.org/gnu/global/global-6.6.11.tar.gz.sig
...
%prep
%setup -q -n global-6.6.11
cd %{_builddir}/global-6.6.11
pushd ..
cp -a global-6.6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701960886
