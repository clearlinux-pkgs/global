...
Version  : 6.6.12
Release  : 28
URL      : https://mirrors.kernel.org/gnu/global/global-6.6.12.tar.gz
Source0  : https://mirrors.kernel.org/gnu/global/global-6.6.12.tar.gz
Source1  : https://mirrors.kernel.org/gnu/global/global-6.6.12.tar.gz.sig
...
%prep
%setup -q -n global-6.6.12
cd %{_builddir}/global-6.6.12
pushd ..
cp -a global-6.6.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709651295
