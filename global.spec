...
Source0  : https://mirrors.kernel.org/gnu/global/global-6.6.9.tar.gz
Source1  : https://mirrors.kernel.org/gnu/global/global-6.6.9.tar.gz.sig
...
%prep
%setup -q -n global-6.6.9
cd %{_builddir}/global-6.6.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671086345
